...
class ParameterConfiguration {
  /// @nodoc
  @internal
  ParameterConfigurationPedestrian internalpedestrian;

  ParameterConfiguration(this.internalpedestrian);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! ParameterConfiguration) return false;
    ParameterConfiguration _other = other;
    return internalpedestrian == _other.internalpedestrian;
  }

  @override
  int get hashCode {
    int result = 7;
    result = 31 * result + internalpedestrian.hashCode;
    return result;
  }
}
...
class ParameterConfigurationPedestrian {
  ...
  /// @nodoc
  @internal
  double internalwalkingSpeedInMetersPerSecond;

  ParameterConfigurationPedestrian(this.internalwalkingSpeedInMetersPerSecond);
  ParameterConfigurationPedestrian.withDefaults()
    : internalwalkingSpeedInMetersPerSecond = 1.0;
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! ParameterConfigurationPedestrian) return false;
    ParameterConfigurationPedestrian _other = other;
    return internalwalkingSpeedInMetersPerSecond == _other.internalwalkingSpeedInMetersPerSecond;
  }

  @override
  int get hashCode {
    int result = 7;
    result = 31 * result + internalwalkingSpeedInMetersPerSecond.hashCode;
    return result;
  }
}
...
Pointer<Void> sdkCoreParameterconfigurationPedestrianToFfi(ParameterConfigurationPedestrian value) {
  final _walkingSpeedInMetersPerSecondHandle = (value.internalwalkingSpeedInMetersPerSecond);
...
ParameterConfigurationPedestrian sdkCoreParameterconfigurationPedestrianFromFfi(Pointer<Void> handle) {
  ...
  try {
    return ParameterConfigurationPedestrian(
...
Pointer<Void> sdkCoreParameterconfigurationToFfi(ParameterConfiguration value) {
  final _pedestrianHandle = sdkCoreParameterconfigurationPedestrianToFfi(value.internalpedestrian);
