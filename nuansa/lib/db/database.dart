...
class DatabaseManager {
  ...
  Future<List> getWisataList({String sortKolom = 'nama', bool descending = false}) async {
    List wisataList = [];
  ...
  void updateUser(UserModel userData) {
    try {
      FirebaseFirestore.instance.collection('list_user').doc(userData.id).update(
        {
          'nama' : userData.nama,
          'email' : userData.email,
          'password' : userData.kataSandi,
          'foto' : userData.foto,
          'wisataFavorite' : userData.wisataFavorite
        }
      );
    } catch (e) {
      print(e);
  ...
  void updateWisata(WisataModel wisataData) {
    try {
      FirebaseFirestore.instance.collection('list_wisata').doc(wisataData.id).update(
        {
          'nama' : wisataData.nama,
          'foto' : wisataData.foto,
          'desa' : wisataData.desa,
          'kecamatan' : wisataData.kecamatan,
          'jamOperasional' : wisataData.jamOperasional,
          'hargaTiket' : wisataData.hargaTiket,
          'jumlahFavorite' : wisataData.jumlahFavorite,
...
//         'jumlahFavorite' : e.jumlahFavorite,
